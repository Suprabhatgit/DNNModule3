var DNNModule3 = DNNModule3 || {};

DNNModule3.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNModule3",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNModule3.user(result.id, result.name);
...
DNNModule3.user = function (id, name) {
    this.id = id;
    this.name = name;
}